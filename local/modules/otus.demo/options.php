...
$aTabsStatic = [
    [
        ...
        'TAB' => Loc::getMessage('OTUS_DEMO_OPTION_MODULE_TAB'),
        'ICON' => '',
        'TITLE' => Loc::getMessage('OTUS_DEMO_OPTION_MODULE_TITLE'),
        'OPTIONS' => [
            [
                'ACTIVE',
                Loc::getMessage('OTUS_DEMO_OPTION_ENABLED'),
                'Y',
                [
                    'checkbox',
                    '',
            ...
            [
                ...
                Loc::getMessage('OTUS_DEMO_OPTION_SELECT_ENTITY'),
                '2',
                [
                    'multiselectbox',
